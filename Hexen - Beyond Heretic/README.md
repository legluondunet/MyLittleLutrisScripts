...
### Description:
Play "Hexen - Beyond Heretic" GOG-STEAM version with "Brutal Hexen RPG" mod on Linux!
### Technical notes:
- Brutal Hexen RPG mod: add RPG features to the gameplay and brutal graphics
- During install, you will need to provide "HEXEN.WAD" file from any "Hexen - Beyond Heretic" GOG-STEAM install
...
# Hexen - Beyond Heretic - GZDoom - GOGSTEAM + Rebirth of Cronos mod
### Description:
