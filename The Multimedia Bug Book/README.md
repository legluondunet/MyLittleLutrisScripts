...
- Once Windows 95 started, go to "My Computer", CD Drive and install the game using setup.exe file, not setup1.exe. If Quicktime does not work, reinstall it with installer available on desktop
