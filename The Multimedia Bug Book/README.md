...
- Once Windows 95 started, go to "My Computer", CD Drive and install the game using setup1.exe file, not setup.exe (do not install Quicktime provided by the game)
